...
const serverAssets = [
  {
    baseName: "server",
    dir: "C:/Users/mateu/Desktop/nuxt/tutorial/127.0.0.1/server/assets",
  },
];
...
storage.mount(
  ...
  unstorage_47drivers_47fs({
    driver: "fs",
    readOnly: false,
    base: "C:\\Users\\mateu\\Desktop\\nuxt\\tutorial\\127.0.0.1\\.nuxt\\cache",
    ignore: ["**/node_modules/**", "**/.git/**"],
  }),
);
storage.mount(
...
const getClientManifest = () =>
  import(
    "file://C:/Users/mateu/Desktop/nuxt/tutorial/127.0.0.1/.nuxt/dist/server/client.manifest.mjs"
  )
    .then((r) => r.default || r)
    .then((r) => (typeof r === "function" ? r() : r));
const getServerEntry = () =>
  import(
    "file://C:/Users/mateu/Desktop/nuxt/tutorial/127.0.0.1/.nuxt/dist/server/server.mjs"
  ).then((r) => r.default || r);
