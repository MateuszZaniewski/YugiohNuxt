...
const serverAssets = [
  {
    baseName: "server",
    dir: "C:/Users/mateu/Desktop/nuxt/tutorial/host/server/assets",
  },
];
...
const getClientManifest = () =>
  import(
    "file://C:/Users/mateu/Desktop/nuxt/tutorial/host/.nuxt/dist/server/client.manifest.mjs"
  )
    .then((r) => r.default || r)
    .then((r) => (typeof r === "function" ? r() : r));
const getServerEntry = () =>
  import(
    "file://C:/Users/mateu/Desktop/nuxt/tutorial/host/.nuxt/dist/server/server.mjs"
  ).then((r) => r.default || r);
