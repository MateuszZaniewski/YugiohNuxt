...
<template>
  ...
  <section
    v-if="userData"
    class="flex pt-7 gap-3 justify-start w-[90%] mx-auto max-w-xl"
  >
  ...
  <section class="flex pt-3 gap-3 justify-start w-[90%] mx-auto max-w-xl">
    <div class="flex justify-center gap-3">
      <UButton
        @click="addUserToFriend(user.email, userData.email, userData.name)"
        class="text-xs px-1 py-1 roundex-3xl bg-[rgba(45,97,175,0.7)]"
        >Add to friends</UButton
      >
      <UButton
        @click="
          removeUserFromFriends(user.email, userData.email, userData.name)
        "
        class="text-xs px-1 py-1 roundex-3xl bg-[rgba(45,97,175,0.7)]"
        >Remove from friends</UButton
      >
    </div>
  </section>
